...
public class AssetGenerationStep : BasePipelineStep<StoryboardResult, AssetGenerationResult>
{
        ...
        CancellationToken ct)
    {
        ...
        context.Logger.LogInformation("阶段 2/4: 生成素材...");
        ...
        var assetTasks = storyboard.Scenes.Select(async scene =>
        {
            ...
            context.Logger.LogDebug("开始生成场景 {Index}/{Total}", scene.Index, totalScenes);
            ...
            context.Logger.LogInformation("场景 {Index}/{Total} 完成 (时长: {Duration:mm\\:ss\\.fff})",
        ...
        context.Logger.LogInformation("素材生成完成,共 {Count} 个素材,总时长: {Duration:mm\\:ss}",
